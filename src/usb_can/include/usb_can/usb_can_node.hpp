...
{
    // subs_.push_back(
    //     nh_.subscribe("/stepper_57/motor_cmd", 100, &TransferStation::cmdCallback, this));
    subs_.push_back(nh_.subscribe("/maxon_re35/motor_cmd", 100, &TransferStation::cmdCallback, this));
    subs_.push_back(nh_.subscribe("/movable_archor/motor_cmd", 100, &TransferStation::cmdCallback, this));
