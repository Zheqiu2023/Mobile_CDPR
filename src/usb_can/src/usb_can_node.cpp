...
int main(int argc, char** argv) {
    ...
    CanInit can_handler;
    can_handler.initCAN(VCI_USBCAN2, DEV_IND0, CAN_IND0, MotorType::MAXON_RE35);  // open USBCAN0 CNA1
    can_handler.initCAN(VCI_USBCAN2, DEV_IND0, CAN_IND1, MotorType::MAXON_RE35);  // open USBCAN0 CNA2
    can_handler.initCAN(VCI_USBCAN2, DEV_IND1, CAN_IND0, MotorType::MAXON_RE35);  // open USBCAN1 CNA1
