...
for i=1:k
    ...
    x_state_initial=[x_state_initial;start_state];
    % 中间状态量约束
    g_constraint_lb=[g_constraint_lb;[-10;-10;0;-pi/18;-pi/18;-pi/2;    -2;-2;-2;-0.3;-0.3;-0.3;    -10;-10;-pi/2;  -2;-pi/4;-0.1]];
    g_constraint_ub=[g_constraint_ub;[10;10;3;pi/18;pi/18;pi/2;   2;2;2;0.3;0.3;0.3;    10;10;pi/2;   2;pi/4;0.1]];
    g_constraint=[g_constraint;x_k];
    % x(k) = A*x(k-1) + B*u
    ...
    % 障碍物约束
    [dis1,dis2,dis3,dis4,dis5] = obs_con(x_k(13:15), x_k(1:3), params);
    g_constraint_lb=[g_constraint_lb;0;0;0;0;0];
    g_constraint_ub=[g_constraint_ub;inf;inf;inf;inf;inf];
    g_constraint=[g_constraint;dis1;dis2;dis3;dis4;dis5];
    % 速度约束
